...
prediction_dir = 'D:\data\cell_images\man\DAP_DNA\\both\\test\MR'
...
# 遍历预测目录中的每个文件
for prediction_file in ground_truth_files:
    # 构建ground_truth文件路径
...
a=pd.DataFrame(lst)
a.to_csv(os.path.join(prediction_dir,'perfomances_MR.csv'),index=None,header=None)
print(lst)
